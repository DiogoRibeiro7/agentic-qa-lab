...
- Wraps a Selenium WebDriver behind the same `open` / `observe` / `execute`
  contract as Playwright.
- Supports selector clicks, text entry, key presses, waits, screenshots, and
